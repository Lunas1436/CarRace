...
#include "CarRaceOffroadCar.h"
#include "CarRaceOffroadWheelFront.h"
#include "CarRaceOffroadWheelRear.h"
...
ACarRaceOffroadCar::ACarRaceOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UCarRaceOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UCarRaceOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UCarRaceOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UCarRaceOffroadWheelRear::StaticClass();
