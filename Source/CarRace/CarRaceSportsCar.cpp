...
#include "CarRaceSportsCar.h"
#include "CarRaceSportsWheelFront.h"
#include "CarRaceSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ACarRaceSportsCar::ACarRaceSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UCarRaceSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UCarRaceSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UCarRaceSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UCarRaceSportsWheelRear::StaticClass();
