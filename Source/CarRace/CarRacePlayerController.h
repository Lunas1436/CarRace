...
#include "CarRacePlayerController.generated.h"
 ...
 */
UCLASS(abstract)
class ACarRacePlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<ACarRacePawn> VehiclePawnClass;

	/** Pointer to the controlled vehicle pawn */
	TObjectPtr<ACarRacePawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, Category="Vehicle|UI")
	TSubclassOf<UCarRaceUI> VehicleUIClass;
